...
/**
 * Demo-only visual supplement for the two difficult classes:
 * door and stair.
 *
 * The normal YOLO model remains responsible for every class.
 * This detector is only a fallback when YOLO does not emit
 * door/stair. It uses compact perceptual signatures generated
 * from the seven supplied reference images.
 */
class DemoReferenceDetector {
    ...
    private val references = listOf(
        ...
        Reference("stair", decode("")),
        Reference("stair", decode("")),
    ...
    fun detect(frame: Bitmap): List<RawDetection> {
        val best = references.minByOrNull { distance(signature(frame), it.signature) }
            ?: return emptyList()
    ...
    private fun signature(bitmap: Bitmap): ByteArray {
        ...
        for (i in pixels.indices) {
            val p = pixels[i]
            val gray = 0.299f * ((p shr 16) and 255) +
